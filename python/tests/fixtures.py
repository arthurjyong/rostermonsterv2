...
# `icu_hd_template_artifact` was promoted to a production-side module under
# M2 C9 Phase 2 so the production CLI (`rostermonster.run`) consumes the
# same template without test-package imports. Re-exported here so existing
# test imports (`from tests.fixtures import icu_hd_template_artifact`)
# continue to work unchanged.
from rostermonster.templates.icu_hd import icu_hd_template_artifact  # noqa: F401
